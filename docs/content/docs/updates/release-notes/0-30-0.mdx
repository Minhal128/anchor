...
check out the
[CHANGELOG](https://github.com/otter-sec/anchor/blob/v0.30.0/CHANGELOG.md#0300---2024-04-15).
...
[this](https://github.com/otter-sec/anchor/pull/2824) if you'd like to learn
more.
...
[this](https://github.com/otter-sec/anchor/blob/v0.30.0/tests/declare-program/programs/declare-program/src/lib.rs)
...
[Here](https://github.com/otter-sec/anchor/blob/v0.30.0/tests/spl/token-extensions/programs/token-extensions/src/instructions.rs)
...
[here](https://github.com/otter-sec/anchor/blob/v0.30.0/ts/packages/anchor/src/idl.ts).
