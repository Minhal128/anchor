...
- If you installed the version `1.1.2`, run `avm use 1.1.2`.
...
```shell title="Terminal"
cargo install --git https://github.com/otter-sec/anchor --tag v1.1.2 anchor-cli
```
...
See [this issue](https://github.com/otter-sec/anchor/issues/3392) for more
information.
