...
[source code](https://github.com/otter-sec/anchor/blob/62865c636aecc6974fc9cfebfc6cf08ca4f0bb72/lang/syn/src/codegen/accounts/constraints.rs)
...
Note that these extensions are not checked when used with `init_if_needed`.
