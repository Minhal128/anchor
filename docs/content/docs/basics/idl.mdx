...
for the
[`gen_discriminator` method here](https://github.com/otter-sec/anchor/blob/62865c636aecc6974fc9cfebfc6cf08ca4f0bb72/lang/syn/src/codegen/program/common.rs#L19-L22),
which is used
