...
pub fn generate(error: Error) -> proc_macro2::TokenStream {
    ...
    let name_variant_dispatch: Vec<proc_macro2::TokenStream> = error
        ...
        .map(|variant| {
            ...
            quote! {
                #enum_name::#ident => ::anchor_lang::__private::ToString::to_string(#ident_name)
            }
        })
        .collect();
    ...
    let ret = quote! {
        ...
        impl #enum_name {
            ...
            pub fn name(&self) -> ::anchor_lang::__private::String {
                match self {
            ...
            fn from(error_code: #enum_name) -> anchor_lang::error::Error {
                anchor_lang::error::Error::from(
                    anchor_lang::error::AnchorError {
                        ...
                        error_msg: ::anchor_lang::__private::ToString::to_string(&error_code),
                        error_origin: None,
