...
pub fn generate(accs: &AccountsStruct) -> proc_macro2::TokenStream {
    ...
    quote! {
        ...
        impl<#combined_generics> anchor_lang::ToAccountInfos<#trait_generics> for #name <#struct_generics> #where_clause{
            fn to_account_infos(&self) -> ::anchor_lang::__private::Vec<anchor_lang::solana_program::account_info::AccountInfo<#trait_generics>> {
                let mut account_infos = ::anchor_lang::__private::Vec::new();
