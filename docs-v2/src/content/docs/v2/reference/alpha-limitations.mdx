...
- `anchor-spl` covers core token, mint, interface account, and several Token-2022 extension paths. Less-common SPL surfaces, especially metadata-oriented constraints, may not be covered yet.
