...
Keep the default `anchor-lang` features while developing. They preserve diagnostics and runtime support that matter while tests, fuzzers, and reviewers are still exercising the program.
