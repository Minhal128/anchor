...
If you're looking to get started, check out [good first issues](https://github.com/otter-sec/anchor/issues?q=is%3Aissue+is%3Aopen+label%3A%22good+first+issue%22) or issues where [help is wanted](https://github.com/otter-sec/anchor/issues?q=is%3Aissue+is%3Aopen+label%3A%22help+wanted%22). For simple documentation changes or typos, feel free to just open a pull request.
...
- If you've moved code around, build the docs with `$ <blue>cargo</blue> doc --open` and adjust broken links
