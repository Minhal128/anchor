...
export const programs: ProgramBenchmark[] = [
  programBenchmark({
    ...
    binary: [124_800, 10_472],
    instructions: [{ label: 'init', detail: 'Counter initialization', older: 5_855, v2: 1_436 }],
  }),
  programBenchmark({
    id: 'prop-amm',
    label: 'prop-amm',
    detail: 'Oracle feed with asm fast-path',
    binary: [140_456, 12_768],
    instructions: [
      { label: 'initialize', detail: 'Oracle setup', older: 4_314, v2: 1_535 },
      { label: 'rotate_authority', detail: 'Authority rotation', older: 1_340, v2: 95 },
  ...
  programBenchmark({
    ...
    binary: [107_544, 6_176],
    instructions: [
      { label: 'deposit', detail: 'System transfer CPI', older: 5_707, v2: 1_917 },
      { label: 'withdraw', detail: 'Lamport withdrawal', older: 2_478, v2: 406 },
    ],
  }),
  programBenchmark({
    id: 'nested',
    ...
    binary: [157_336, 16_808],
    instructions: [
      { label: 'initialize', detail: 'Shared validation setup', older: 19_842, v2: 2_842 },
      { label: 'increment', detail: 'Nested validation path', older: 4_751, v2: 860 },
      { label: 'reset', detail: 'Nested reset path', older: 4_752, v2: 858 },
    ],
  }),
  programBenchmark({
    id: 'multisig',
    ...
    binary: [170_096, 37_424],
    instructions: [
      { label: 'create', detail: 'Config creation', older: 12_031, v2: 3_098 },
      { label: 'deposit', detail: 'Vault funding', older: 4_872, v2: 1_651 },
      { label: 'set_label', detail: 'Inline PodVec update', older: 4_324, v2: 661 },
      { label: 'execute_transfer', detail: 'Threshold transfer', older: 7_446, v2: 2_402 },
    ],
  }),
]
